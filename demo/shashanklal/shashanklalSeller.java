...
public class shashanklalSeller extends ecomm.Seller// Here shashankSeller is the child class of Seller in ecomm folder
{
    ...
    // Initialise the member platform for the respective seller object and addseller
    // to the platform
    ...
    private void generateproducts() {
        ...
        int numberofproducts = random.nextInt(10);
    ...
    // List of all the mobile names from which name of that particular mobile will
    // be given randomly
